...
exports.default = (0, _createReactClass2.default)({
  ...
  makeDateValues: function makeDateValues(isoString) {
    ...
    var selectedDate = isoString ? new Date('' + isoString.slice(0, 10)) : null;
    var minDate = this.props.minDate ? new Date('' + this.props.minDate.slice(0, 10)) : null;
    var maxDate = this.props.maxDate ? new Date('' + this.props.maxDate.slice(0, 10)) : null;

    var inputValue = isoString ? this.makeInputValueString(selectedDate, dateFormat) : null;
    if (selectedDate) {
  ...
  makeInputValueString: function makeInputValueString(date) {
    ...
    var dateFormatToBeUsed = dateFormat ? dateFormat : this.props.dateFormat;
    //this method is executed during intialState setup... handle a missing state properly
    var separator = this.state ? this.state.separator : dateFormatToBeUsed.match(/[^A-Z]/)[0];
